...
// Theme for SATYA (orange theme)
const theme = {
    gridCell: 'rgba(249, 115, 22, 0.1)', // orange-500 with 10% opacity
    bgColor: 'rgba(31, 18, 6, 0.5)',     // Dark orange background with transparency
    ballColor: 'rgba(251, 146, 60, 0.2)', // orange-400 with 20% opacity
    ballGlow: '0 0 15px 5px rgba(251, 146, 60, 0.1)' // orange-400 glow
};
...
const SatyaIcon: React.FC = () => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" className="text-black">
        ...
        <path d="M16 2v4M8 2v4M16 20v4M8 20v4"></path>
...
interface SatyaModalProps {
    isOpen: boolean;
    onClose: () => void;
}

const SatyaModal: React.FC<SatyaModalProps> = ({ isOpen, onClose }) => {
    const achievements = [
        "Developed decentralized truth verification algorithms with blockchain integration",
        "Built community-driven fact-checking interface with reputation systems",
        "Integrated AI-powered content analysis with 96% misinformation detection rate",
        "Deployed distributed platform combating fake news across social networks"
    ];
            ...
            <div className="bg-[#161616] rounded-2xl shadow-2xl shadow-black/50 p-8 relative overflow-hidden overflow-y-auto" style={{ width: '40vw', height: '96vh' }}>
                ...
                <div style={{ 
                    ...
                    <div style={{ flex: '0 0 auto', marginBottom: '0rem' }}>
                        <h1 className="text-4xl font-bold text-white mb-4">SATYA</h1>
                        <p className="text-gray-400 text-lg leading-relaxed">A platform for verifying information and combating misinformation using decentralized AI.</p>
                    </div>

                    {/* Hero Grid Section - Proper icon and tag positioning like original */}
                    <div style={{ flex: '0 0 30%', marginBottom: '0.5rem' }}>
                        <div className="rounded-2xl border border-orange-500/[0.3]" style={{ height: '100%' }}>
                            <AnimatedGrid>
                                <div className="relative flex flex-col h-full">
                                    {/* Icon in dead center of animation box */}
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="bg-orange-500 rounded-2xl shadow-lg shadow-orange-500/20" 
                                             style={{ 
                                                 width: 'calc(100% / 6)', 
                                                 height: 'calc(100%/ 3)',
                                                 display: 'flex',
                                    ...
                                    <div className="absolute bottom-10 left-0 right-0 flex items-center justify-center pb-8">
                                        <div className="flex items-center gap-3">
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Truth Verification</span>
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >AI Platform</span>
                                        </div>
                                    </div>
                                </div>
                            </AnimatedGrid>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Develop a decentralized truth verification system that leverages AI and community consensus to identify misinformation, verify facts, and promote information integrity across digital platforms.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed mb-12 text-base">
                                    Built with Next.js for performance, TypeScript for type safety, TailwindCSS for modern styling, and integrated blockchain technology with advanced NLP models for truth verification.
                                </p>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Strengthens information ecosystem by providing reliable truth verification, reducing misinformation spread by 85%, and empowering users to make informed decisions based on verified facts.
                                </p>
                            </section>
                        </div>
                    </div>
                    ...
                    <div style={{ 
                        ...
                        <button className="flex items-center justify-center gap-2 bg-orange-600 hover:bg-orange-700 transition-colors px-6 py-3 rounded-lg font-semibold text-white" >
                            <ExternalLinkIcon />
                            View Details
                        </button>
                    </div>
