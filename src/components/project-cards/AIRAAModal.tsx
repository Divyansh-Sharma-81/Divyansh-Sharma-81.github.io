...
// Theme for AIRAA Projects (purple theme)
const theme = {
    gridCell: 'rgba(168, 85, 247, 0.1)', // purple-500 with 10% opacity
    bgColor: 'rgba(22, 9, 31, 0.5)',     // Dark purple background with transparency
    ballColor: 'rgba(192, 132, 252, 0.2)', // purple-400 with 20% opacity
    ballGlow: '0 0 15px 5px rgba(192, 132, 252, 0.1)' // purple-400 glow
};
...
const AIRAAIcon: React.FC = () => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" className="text-black">
        ...
        <path d="M7.5 14.5L12 16l4.5-1.5"></path>
    </svg>
);
...
interface AIRAAModalProps {
    isOpen: boolean;
    onClose: () => void;
}

const AIRAAModal: React.FC<AIRAAModalProps> = ({ isOpen, onClose }) => {
    const achievements = [
        "Developed AI-powered style recommendation engine with 92% accuracy",
        "Built intuitive fashion discovery interface with personalized feeds",
        "Integrated wardrobe management with outfit planning capabilities",
        "Deployed scalable platform serving fashion-conscious users globally"
    ];
            ...
            <div className="bg-[#161616] rounded-2xl shadow-2xl shadow-black/50 p-8 relative overflow-hidden overflow-y-auto" style={{ width: '40vw', height: '96vh' }}>
                ...
                <div style={{ 
                    ...
                    <div style={{ flex: '0 0 auto', marginBottom: '0rem' }}>
                        <h1 className="text-4xl font-bold text-white mb-4">AIRAA Projects</h1>
                        <p className="text-gray-400 text-lg leading-relaxed">A fashion-forward outfit recommendation platform leveraging AI to personalize your style.</p>
                    </div>

                    {/* Hero Grid Section - Proper icon and tag positioning like original */}
                    <div style={{ flex: '0 0 30%', marginBottom: '0.5rem' }}>
                        <div className="rounded-2xl border border-purple-500/[0.3]" style={{ height: '100%' }}>
                            <AnimatedGrid>
                                <div className="relative flex flex-col h-full">
                                    {/* Icon in dead center of animation box */}
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="bg-purple-500 rounded-2xl shadow-lg shadow-purple-500/20" 
                                             style={{ 
                                                 width: 'calc(100% / 6)', 
                                                 height: 'calc(100%/ 3)',
                                                 display: 'flex',
                                    ...
                                    <div className="absolute bottom-10 left-0 right-0 flex items-center justify-center pb-8">
                                        <div className="flex items-center gap-3">
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >AI Fashion</span>
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Recommendations</span>
                                        </div>
                                    </div>
                                </div>
                            </AnimatedGrid>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Develop an intelligent fashion platform that analyzes personal style preferences, body type, and current trends to provide personalized outfit recommendations and style advice.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed mb-12 text-base">
                                    Built with Next.js for performance, TypeScript for type safety, TailwindCSS for modern styling, and integrated advanced computer vision models for fashion analysis and recommendation.
                                </p>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Revolutionizes fashion discovery by helping users make confident style choices, reduce decision fatigue, and express their personality through curated, AI-powered fashion recommendations.
                                </p>
                            </section>
                        </div>
                    </div>
                    ...
                    <div style={{ 
                        ...
                        <button className="flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 transition-colors px-6 py-3 rounded-lg font-semibold text-white" >
                            <ExternalLinkIcon />
                            View Details
                        </button>
                    </div>
