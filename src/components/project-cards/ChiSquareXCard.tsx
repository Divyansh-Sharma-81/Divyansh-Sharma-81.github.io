...
import ChiSquareXModal from './ChiSquareXModal';
...
const ChiSquareXCard: React.FC = () => {
    ...
    return (
        ...
        <div className="w-80 rounded-2xl p-4 text-white border border-white/10 glass-panel glass-panel--button cursor-pointer" style={hoverStyle} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} onClick={openModal}>
            <AnimatedGrid>
                ...
                <div className="flex justify-center items-center gap-2">
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full glass-panel glass-panel--chat-element" style={{ color: theme.text }}>Data Analysis</span>
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full glass-panel glass-panel--chat-element" style={{ color: theme.text }}>Statistics</span>
                </div>
            </AnimatedGrid>
        ...
        {/* ChiSquareX Modal */}
        <ChiSquareXModal isOpen={isModalOpen} onClose={closeModal} />
        </>
    );
};
