        ...
        <div className="w-80 rounded-2xl p-4 text-white border border-white/10 glass-panel glass-panel--button" style={hoverStyle} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            <AnimatedGrid>
                ...
                <div className="flex justify-center items-center gap-2">
                    <span className="text-sm font-medium glass-panel glass-panel--chat-element px-4 py-1.5 rounded-full" style={{ color: theme.text }}>Data Science</span>
                    <span className="text-sm font-medium glass-panel glass-panel--chat-element px-4 py-1.5 rounded-full" style={{ color: theme.text }}>AI Platform</span>
                </div>
            </AnimatedGrid>
