...
// Theme for Conference Agent (red theme)
const theme = {
    gridCell: 'rgba(239, 68, 68, 0.1)', // red-500 with 10% opacity
    bgColor: 'rgba(31, 13, 13, 0.5)',   // Dark red background with transparency
    ballColor: 'rgba(248, 113, 113, 0.2)', // red-400 with 20% opacity
    ballGlow: '0 0 15px 5px rgba(248, 113, 113, 0.1)' // red-400 glow
};
...
const ConferenceAgentIcon: React.FC = () => (
...
interface ConferenceAgentModalProps {
    isOpen: boolean;
    onClose: () => void;
}

const ConferenceAgentModal: React.FC<ConferenceAgentModalProps> = ({ isOpen, onClose }) => {
    const achievements = [
        "Developed intelligent scheduling system with conflict resolution algorithms",
        "Built real-time collaboration interface for conference coordination",
        "Integrated automated logistics management with 98% accuracy rate",
        "Deployed scalable agent serving major conference organizations"
    ];
            ...
            <div className="bg-[#161616] rounded-2xl shadow-2xl shadow-black/50 p-8 relative overflow-hidden overflow-y-auto" style={{ width: '40vw', height: '96vh' }}>
                ...
                <div style={{ 
                    ...
                    <div style={{ flex: '0 0 auto', marginBottom: '0rem' }}>
                        <h1 className="text-4xl font-bold text-white mb-4">Conference Agent</h1>
                        <p className="text-gray-400 text-lg leading-relaxed">An intelligent AI agent for organizing and managing conference schedules and logistics.</p>
                    </div>

                    {/* Hero Grid Section - Proper icon and tag positioning like original */}
                    <div style={{ flex: '0 0 30%', marginBottom: '0.5rem' }}>
                        <div className="rounded-2xl border border-red-500/[0.3]" style={{ height: '100%' }}>
                            <AnimatedGrid>
                                <div className="relative flex flex-col h-full">
                                    {/* Icon in dead center of animation box */}
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="bg-red-500 rounded-2xl shadow-lg shadow-red-500/20" 
                                             style={{ 
                                                 width: 'calc(100% / 6)', 
                                                 height: 'calc(100%/ 3)',
                                                 display: 'flex',
                                    ...
                                    <div className="absolute bottom-10 left-0 right-0 flex items-center justify-center pb-8">
                                        <div className="flex items-center gap-3">
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >AI Agent</span>
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Scheduling</span>
                                        </div>
                                    </div>
                                </div>
                            </AnimatedGrid>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Build an autonomous AI agent that handles complex conference logistics, from scheduling sessions and managing speaker coordination to optimizing venue layouts and attendee flow.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed mb-12 text-base">
                                    Built with Next.js for performance, TypeScript for type safety, TailwindCSS for modern styling, and integrated advanced AI planning algorithms for intelligent conference management.
                                </p>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Transforms event management by automating complex scheduling tasks, reducing organizational overhead by 80%, and ensuring seamless conference experiences through intelligent coordination.
                                </p>
                            </section>
                        </div>
                    </div>
                    ...
                    <div style={{ 
                        ...
                        <button className="flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 transition-colors px-6 py-3 rounded-lg font-semibold text-white" >
                            <ExternalLinkIcon />
                            View Details
                        </button>
                    </div>
...
export default ConferenceAgentModal;