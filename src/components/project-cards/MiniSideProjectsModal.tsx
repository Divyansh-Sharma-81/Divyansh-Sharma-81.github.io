...
// Theme for Mini Side Projects (indigo theme)
const theme = {
    gridCell: 'rgba(99, 102, 241, 0.1)', // indigo-500 with 10% opacity
    bgColor: 'rgba(14, 14, 31, 0.5)',    // Dark indigo background with transparency
    ballColor: 'rgba(129, 140, 248, 0.2)', // indigo-400 with 20% opacity
    ballGlow: '0 0 15px 5px rgba(129, 140, 248, 0.1)' // indigo-400 glow
};
...
const MiniSideProjectsIcon: React.FC = () => (
...
interface MiniSideProjectsModalProps {
    isOpen: boolean;
    onClose: () => void;
}

const MiniSideProjectsModal: React.FC<MiniSideProjectsModalProps> = ({ isOpen, onClose }) => {
    const achievements = [
        "Developed creative coding experiments exploring innovative web technologies",
        "Built interactive prototypes showcasing emerging development trends",
        "Integrated experimental APIs and frameworks with 95% learning success rate",
        "Deployed diverse collection of mini-projects demonstrating technical versatility"
    ];
            ...
            <div className="bg-[#161616] rounded-2xl shadow-2xl shadow-black/50 p-8 relative overflow-hidden overflow-y-auto" style={{ width: '40vw', height: '96vh' }}>
                ...
                <div style={{ 
                    ...
                    <div style={{ flex: '0 0 auto', marginBottom: '0rem' }}>
                        <h1 className="text-4xl font-bold text-white mb-4">Mini Side Projects</h1>
                        <p className="text-gray-400 text-lg leading-relaxed">A curated collection of experimental side projects and creative coding explorations.</p>
                    </div>

                    {/* Hero Grid Section - Proper icon and tag positioning like original */}
                    <div style={{ flex: '0 0 30%', marginBottom: '0.5rem' }}>
                        <div className="rounded-2xl border border-indigo-500/[0.3]" style={{ height: '100%' }}>
                            <AnimatedGrid>
                                <div className="relative flex flex-col h-full">
                                    {/* Icon in dead center of animation box */}
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="bg-indigo-500 rounded-2xl shadow-lg shadow-indigo-500/20" 
                                             style={{ 
                                                 width: 'calc(100% / 6)', 
                                                 height: 'calc(100%/ 3)',
                                                 display: 'flex',
                                    ...
                                    <div className="absolute bottom-10 left-0 right-0 flex items-center justify-center pb-8">
                                        <div className="flex items-center gap-3">
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Experiments</span>
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Portfolio</span>
                                        </div>
                                    </div>
                                </div>
                            </AnimatedGrid>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Explore and experiment with cutting-edge web technologies through small, focused projects that push creative boundaries and showcase innovative development approaches.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed mb-12 text-base">
                                    Built with Next.js for performance, TypeScript for type safety, TailwindCSS for modern styling, and integrated various experimental libraries for creative exploration and rapid prototyping.
                                </p>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Demonstrates technical creativity and continuous learning through diverse mini-projects, showcasing problem-solving skills and exploration of emerging technologies in web development.
                                </p>
                            </section>
                        </div>
                    </div>
                    ...
                    <div style={{ 
                        ...
                        <button className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 transition-colors px-6 py-3 rounded-lg font-semibold text-white" >
                            <ExternalLinkIcon />
                            View Details
                        </button>
                    </div>
...
export default MiniSideProjectsModal;