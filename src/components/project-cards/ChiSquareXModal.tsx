...
// Theme for Chi-SquareX Projects (pink theme)
const theme = {
    gridCell: 'rgba(236, 72, 153, 0.1)', // pink-500 with 10% opacity
    bgColor: 'rgba(31, 13, 22, 0.5)',    // Dark pink background with transparency
    ballColor: 'rgba(244, 114, 182, 0.2)', // pink-400 with 20% opacity
    ballGlow: '0 0 15px 5px rgba(244, 114, 182, 0.1)' // pink-400 glow
};
...
const ChiSquareXIcon: React.FC = () => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" className="text-black">
        <path d="M9 9h1.5a2.5 2.5 0 1 1 0 5h-1.5v-5z"></path>
        <path d="M9 15h1.5a2.5 2.5 0 1 1 0 5H9v-5z"></path>
...
interface ChiSquareXModalProps {
    isOpen: boolean;
    onClose: () => void;
}

const ChiSquareXModal: React.FC<ChiSquareXModalProps> = ({ isOpen, onClose }) => {
    const achievements = [
        "Developed advanced statistical modeling algorithms for complex data analysis",
        "Built interactive visualization dashboard with real-time chart updates",
        "Integrated hypothesis testing suite with 99% statistical accuracy",
        "Deployed comprehensive analytics platform serving research institutions"
    ];
            ...
            <div className="bg-[#161616] rounded-2xl shadow-2xl shadow-black/50 p-8 relative overflow-hidden overflow-y-auto" style={{ width: '40vw', height: '96vh' }}>
                ...
                <div style={{ 
                    ...
                    <div style={{ flex: '0 0 auto', marginBottom: '0rem' }}>
                        <h1 className="text-4xl font-bold text-white mb-4">Chi-SquareX Projects</h1>
                        <p className="text-gray-400 text-lg leading-relaxed">A suite of tools for advanced statistical analysis and data visualization projects.</p>
                    </div>

                    {/* Hero Grid Section - Proper icon and tag positioning like original */}
                    <div style={{ flex: '0 0 30%', marginBottom: '0.5rem' }}>
                        <div className="rounded-2xl border border-pink-500/[0.3]" style={{ height: '100%' }}>
                            <AnimatedGrid>
                                <div className="relative flex flex-col h-full">
                                    {/* Icon in dead center of animation box */}
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="bg-pink-500 rounded-2xl shadow-lg shadow-pink-500/20" 
                                             style={{ 
                                                 width: 'calc(100% / 6)', 
                                                 height: 'calc(100%/ 3)',
                                                 display: 'flex',
                                    ...
                                    <div className="absolute bottom-10 left-0 right-0 flex items-center justify-center pb-8">
                                        <div className="flex items-center gap-3">
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Data Analysis</span>
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Statistics</span>
                                        </div>
                                    </div>
                                </div>
                            </AnimatedGrid>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Build a comprehensive statistical analysis toolkit that enables researchers and data scientists to perform advanced statistical tests, create insightful visualizations, and extract meaningful patterns from complex datasets.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed mb-12 text-base">
                                    Built with Next.js for performance, TypeScript for type safety, TailwindCSS for modern styling, and integrated advanced statistical libraries for robust data analysis and visualization.
                                </p>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Accelerates research and analysis by providing intuitive statistical tools, reducing analysis time by 60%, and enabling researchers to uncover insights with confidence and statistical rigor.
                                </p>
                            </section>
                        </div>
                    </div>
                    ...
                    <div style={{ 
                        ...
                        <button className="flex items-center justify-center gap-2 bg-pink-600 hover:bg-pink-700 transition-colors px-6 py-3 rounded-lg font-semibold text-white" >
                            <ExternalLinkIcon />
                            View Details
                        </button>
                    </div>
...
export default ChiSquareXModal;