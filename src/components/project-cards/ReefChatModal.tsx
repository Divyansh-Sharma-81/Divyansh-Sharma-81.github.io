...
// Theme for Reef-Chat (teal theme)
const theme = {
    gridCell: 'rgba(20, 184, 166, 0.1)', // teal-500 with 10% opacity
    bgColor: 'rgba(5, 26, 23, 0.5)',     // Dark teal background with transparency
    ballColor: 'rgba(45, 212, 191, 0.2)', // teal-400 with 20% opacity
    ballGlow: '0 0 15px 5px rgba(45, 212, 191, 0.1)' // teal-400 glow
};
...
const ReefChatIcon: React.FC = () => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" className="text-black">
        ...
        <path d="M9 9h.01M15 9h.01M9 13h6"></path>
    </svg>
);
...
interface ReefChatModalProps {
    isOpen: boolean;
    onClose: () => void;
}

const ReefChatModal: React.FC<ReefChatModalProps> = ({ isOpen, onClose }) => {
    const achievements = [
        "Developed natural language processing for accurate query understanding",
        "Built real-time chat interface with instant response capabilities",
        "Integrated customer context awareness with 95% satisfaction rate",
        "Deployed scalable chatbot serving 24/7 customer support"
    ];
            ...
            <div className="bg-[#161616] rounded-2xl shadow-2xl shadow-black/50 p-8 relative overflow-hidden overflow-y-auto" style={{ width: '40vw', height: '96vh' }}>
                ...
                <div style={{ 
                    ...
                    <div style={{ flex: '0 0 auto', marginBottom: '0rem' }}>
                        <h1 className="text-4xl font-bold text-white mb-4">Reef-Chat</h1>
                        <p className="text-gray-400 text-lg leading-relaxed">An AI-powered chatbot for providing instant, intelligent customer support and engagement.</p>
                    </div>

                    {/* Hero Grid Section - Proper icon and tag positioning like original */}
                    <div style={{ flex: '0 0 30%', marginBottom: '0.5rem' }}>
                        <div className="rounded-2xl border border-teal-500/[0.3]" style={{ height: '100%' }}>
                            <AnimatedGrid>
                                <div className="relative flex flex-col h-full">
                                    {/* Icon in dead center of animation box */}
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="bg-teal-500 rounded-2xl shadow-lg shadow-teal-500/20" 
                                             style={{ 
                                                 width: 'calc(100% / 6)', 
                                                 height: 'calc(100%/ 3)',
                                                 display: 'flex',
                                    ...
                                    <div className="absolute bottom-10 left-0 right-0 flex items-center justify-center pb-8">
                                        <div className="flex items-center gap-3">
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Chatbot</span>
                                            <span className="bg-gray-800/50 text-gray-300 text-base font-semibold px-6 py-3 mx-2 rounded-full border border-gray-700 text-center" >Customer Support</span>
                                        </div>
                                    </div>
                                </div>
                            </AnimatedGrid>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Build an intelligent chatbot system that provides instant, context-aware customer support with natural conversation flow and seamless integration across multiple platforms.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed mb-12 text-base">
                                    Built with Next.js for performance, TypeScript for type safety, TailwindCSS for modern styling, and integrated advanced NLP frameworks for intelligent conversation management.
                                </p>
                            ...
                            <section>
                                ...
                                <p className="text-gray-400 leading-relaxed text-base">
                                    Transforms customer service by providing instant, accurate responses, reducing support tickets by 70%, and improving customer satisfaction through intelligent, personalized interactions.
                                </p>
                            </section>
                        </div>
                    </div>
                    ...
                    <div style={{ 
                        ...
                        <button className="flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 transition-colors px-6 py-3 rounded-lg font-semibold text-white" >
                            <ExternalLinkIcon />
                            View Details
                        </button>
                    </div>
