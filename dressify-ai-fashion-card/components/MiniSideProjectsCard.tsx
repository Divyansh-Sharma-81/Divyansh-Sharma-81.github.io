...
const theme: ThemeColors = { main: '#6366f1', glow: '#6366f1', text: '#a5b4fc', pillBg: 'rgba(99, 102, 241, 0.1)', pillText: '#818cf8', gradientFrom: '#818cf8', gradientTo: '#6366f1', gridCell: 'rgba(165, 180, 252, 0.07)', bgColor: '#0e0e1f' };
const title = "Mini Side Projects";
...
const CardIcon = () => ( <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" className="text-white"><path d="M20 7h-9"></path><path d="M11 12h9"></path><path d="M11 17h9"></path><path d="M4 17a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"></path><path d="M4 12a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"></path><path d="M4 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"></path></svg> );
...
const MiniSideProjectsCard: React.FC = () => {
        ...
        <div className="w-80 bg-[#1c1c1c] rounded-2xl p-4 text-white border border-white/10" style={hoverStyle} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            <AnimatedGrid>
                ...
                <div className="flex justify-center items-center gap-2">
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full" style={{ color: theme.text }}>Experiments</span>
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full" style={{ color: theme.text }}>Portfolio</span>
                </div>
            </AnimatedGrid>

            <div className="pt-5 pb-2">
                <h2 className="text-2xl font-bold text-gray-50">{title}</h2>
                <p className="text-gray-400 mt-1.5 text-base leading-relaxed">A curated collection of experimental side projects and creative coding explorations.</p>
            </div>
...
export default MiniSideProjectsCard;
