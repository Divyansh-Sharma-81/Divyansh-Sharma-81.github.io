...
const theme: ThemeColors = { main: '#ec4899', glow: '#ec4899', text: '#f9a8d4', pillBg: 'rgba(236, 72, 153, 0.1)', pillText: '#f472b6', gradientFrom: '#f472b6', gradientTo: '#ec4899', gridCell: 'rgba(249, 168, 212, 0.07)', bgColor: '#1f0d16' };
const title = "Chi-SquareX Projects";
...
const CardIcon = () => ( <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" className="text-white"><path d="M17.5 19H9a7 7 0 1 1 6.32-10.95A5 5 0 1 1 18 19.95Z"></path></svg> );
        ...
        <div className="w-80 bg-[#1c1c1c] rounded-2xl p-4 text-white border border-white/10" style={hoverStyle} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            <AnimatedGrid>
                ...
                <div className="flex justify-center items-center gap-2">
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full" style={{ color: theme.text }}>Data Analysis</span>
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full" style={{ color: theme.text }}>Statistics</span>
                </div>
            </AnimatedGrid>

            <div className="pt-5 pb-2">
                <h2 className="text-2xl font-bold text-gray-50">{title}</h2>
                <p className="text-gray-400 mt-1.5 text-base leading-relaxed">A suite of tools for advanced statistical analysis and data visualization projects.</p>
            </div>
