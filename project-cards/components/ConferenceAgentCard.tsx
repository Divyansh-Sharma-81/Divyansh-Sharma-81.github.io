        ...
        <div className="w-80 bg-[#1c1c1c] rounded-2xl p-4 text-white border border-white/10" style={hoverStyle} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            <AnimatedGrid>
                ...
                <div className="flex justify-center items-center gap-2">
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full" style={{ color: theme.text }}>AI Agent</span>
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full" style={{ color: theme.text }}>Scheduling</span>
                </div>
            </AnimatedGrid>
