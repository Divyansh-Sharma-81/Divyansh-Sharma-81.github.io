...
const theme: ThemeColors = { main: '#14b8a6', glow: '#14b8a6', text: '#5eead4', pillBg: 'rgba(20, 184, 166, 0.1)', pillText: '#2dd4bf', gradientFrom: '#2dd4bf', gradientTo: '#14b8a6', gridCell: 'rgba(94, 234, 212, 0.07)', bgColor: '#051a17' };
const title = "Reef-Chat";
...
const CardIcon = () => ( <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" className="text-white"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg> );
        ...
        <div className="w-80 bg-[#1c1c1c] rounded-2xl p-4 text-white border border-white/10" style={hoverStyle} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            <AnimatedGrid>
                ...
                <div className="flex justify-center items-center gap-2">
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full" style={{ color: theme.text }}>Chatbot</span>
                    <span className="text-sm font-medium bg-black/30 backdrop-blur-sm px-4 py-1.5 rounded-full" style={{ color: theme.text }}>Customer Support</span>
                </div>
            </AnimatedGrid>

            <div className="pt-5 pb-2">
                <h2 className="text-2xl font-bold text-gray-50">{title}</h2>
                <p className="text-gray-400 mt-1.5 text-base leading-relaxed">An AI-powered chatbot for providing instant, intelligent customer support and engagement.</p>
            </div>
